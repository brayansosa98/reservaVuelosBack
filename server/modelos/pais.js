...
function crearPaisesDepartamentosCiudades() {
  if (Modelos.paises.find().count() === 0) {
    let paises = [
      {
        nombre: "Colombia",
        codigo: "CO",
    ...
    paises.forEach((pais) => {
      let departamentos = pais.departamentos;
      delete pais.departamentos;
      let id_pais = Modelos.paises.insert(pais);
      departamentos.forEach((departamento) => {
        let ciudades = departamento.ciudades;
        delete departamento.ciudades;
        departamento.id_pais = id_pais;
        departamento.codigo = "";
        let id_departamento = Modelos.departamentos.insert(departamento);
    ...
    console.log("paises, departamentos y ciudades creadas ");
  }
}
